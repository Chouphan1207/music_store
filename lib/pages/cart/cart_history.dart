...
import 'package:music_store/base/no_data_page.dart';
  ...
  Widget build(BuildContext context) {
    ...
    Widget timeWidget(int index){
      ...
      if(index<getCartHistoryList.length){
        DateTime parseDate= DateFormat("yy-MM-dd HH:mm:ss").parse(getCartHistoryList[listCounter].time!);
        ...
        children: [
          Container(
            ...
            child: Row(
              ...
              children: [
                BigText(text: "Your Wish List",color: AppColors.mainColor,size: Dimensions.font18*1.2,),
